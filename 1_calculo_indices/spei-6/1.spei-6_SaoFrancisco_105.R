# ============================================================================
# SPEI calculation — Sao Francisco basin
# Scenarios: Historical (1985-2014), SSP126 (2041-2070), SSP585 (2041-2070)
# Baseline: Common 1965-2014 / 1965-2070 (106 years)
...
path_out_base <- "/data/brussel/vo/000/bvo00033/vsc11346/SPEI_R/3.outputs_SPEI_R/5.baseline_106_6ac_OF/Sao_Francisco/"

scenarios <- list(
    historical = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Sao_Francisco/historical/"),
    ...
    ssp126 = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Sao_Francisco/historical/"),
        path_D_gap     = paste0(path_D_base, "2.baseline_120/Sao_Francisco/ssp126/"),
        path_D_fut     = paste0(path_D_base, "1.baseline_50/Sao_Francisco/ssp126/"),
    ...
    ssp585 = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Sao_Francisco/historical/"),
        path_D_gap     = paste0(path_D_base, "2.baseline_120/Sao_Francisco/ssp585/"),
        path_D_fut     = paste0(path_D_base, "1.baseline_50/Sao_Francisco/ssp585/"),
...
for (scenario_name in names(scenarios)) {
    ...
    for (model in models) {
        ...
        # --- SAVE NetCDF ---
        output_file <- paste0(cfg$path_out, "spei6_", basin, "_",
        ...
        spei_var <- ncvar_def(
            ...
            missval  = -9999,
            longname = "SPEI-6 (R SPEI package, log-Logistic, ub-pwm, baseline 1965-2070)"
        )
...
print("All scenarios completed — Sao Francisco, 5 models.")