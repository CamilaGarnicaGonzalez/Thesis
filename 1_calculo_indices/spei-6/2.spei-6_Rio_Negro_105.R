# ============================================================================
# SPEI calculation — Rio Negro basin
...
path_out_base <- "/data/brussel/vo/000/bvo00033/vsc11346/SPEI_R/3.outputs_SPEI_R/5.baseline_106_6ac_OF/Rio_Negro/"

scenarios <- list(
    historical = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Rio_Negro/historical/"),
    ...
    ssp126 = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Rio_Negro/historical/"),
        path_D_gap     = paste0(path_D_base, "2.baseline_120/Rio_Negro/ssp126/"),
        path_D_fut     = paste0(path_D_base, "1.baseline_50/Rio_Negro/ssp126/"),
    ...
    ssp585 = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Rio_Negro/historical/"),
        path_D_gap     = paste0(path_D_base, "2.baseline_120/Rio_Negro/ssp585/"),
        path_D_fut     = paste0(path_D_base, "1.baseline_50/Rio_Negro/ssp585/"),
...
print("All scenarios completed — Rio Negro, 5 models.")