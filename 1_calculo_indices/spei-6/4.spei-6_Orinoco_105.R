# ============================================================================
# SPEI calculation — Orinoco basin
...
path_out_base <- "/data/brussel/vo/000/bvo00033/vsc11346/SPEI_R/3.outputs_SPEI_R/5.baseline_106_6ac_OF/Orinoco/"

scenarios <- list(
    historical = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Orinoco/historical/"),
    ...
    ssp126 = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Orinoco/historical/"),
        path_D_gap     = paste0(path_D_base, "2.baseline_120/Orinoco/ssp126/"),
        path_D_fut     = paste0(path_D_base, "1.baseline_50/Orinoco/ssp126/"),
    ...
    ssp585 = list(
        path_D_hist    = paste0(path_D_base, "1.baseline_50/Orinoco/historical/"),
        path_D_gap     = paste0(path_D_base, "2.baseline_120/Orinoco/ssp585/"),
        path_D_fut     = paste0(path_D_base, "1.baseline_50/Orinoco/ssp585/"),
...
print("All scenarios completed — Orinoco, 5 models.")